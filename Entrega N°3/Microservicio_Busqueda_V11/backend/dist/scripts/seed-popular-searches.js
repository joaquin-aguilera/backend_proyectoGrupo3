 ...
 */
function generateSearchesForProduct(productId, productName, categoria, count) {
    const searches = [];
    const now = new Date();
...
function seedSearches() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield Search_1.default.deleteMany({});
            console.log('✅ Búsquedas antiguas eliminadas');
            console.log('📝 Generando búsquedas de ejemplo...');
            let totalSearches = 0;
            const allSearches = [];
            for (const product of searchData) {
                const searches = generateSearchesForProduct(product.productId, product.productName, product.categoria, product.searches);
            ...
            yield Search_1.default.insertMany(allSearches);
            console.log('\n✅ ¡Proceso completado!');
