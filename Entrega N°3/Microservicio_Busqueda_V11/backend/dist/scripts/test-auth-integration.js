 ...
 */
function testAuthServiceAvailability() {
...
function testLogin() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield axios_1.default.post(`${AUTH_SERVICE_URL}/auth/login`, credentials, {
                timeout: 5000
            });
            ...
            console.log('   Error:', ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || error.message);
 ...
 */
function testSearchWithoutAuth() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        log('cyan', '\n🧪 Test 4: Búsqueda sin autenticación...');
        try {
            const response = yield axios_1.default.get(`${SEARCH_SERVICE_URL}/search`, {
                params: {
                    busqueda: 'laptop'
                },
                timeout: 5000
 ...
 */
function testSearchWithAuth(token) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
...
function testHealthCheck() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield axios_1.default.get(`${SEARCH_SERVICE_URL.replace('/api', '')}/health`, {
                timeout: 5000
            });
 ...
 */
function testCheckPermission(token) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
...
function runAllTests() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const authAvailable = yield testAuthServiceAvailability();
        ...
        if (authAvailable) {
            // Test 2: Login
            token = yield testLogin();
            token ? results.passed++ : results.failed++;
            if (token) {
                // Test 3: Verificar token
                const user = yield testVerifyToken(token);
                user ? results.passed++ : results.failed++;
                // Test 7: Verificar permisos
                const hasPermission = yield testCheckPermission(token);
                hasPermission ? results.passed++ : results.failed++;
            }
        }
        // Test 4: Búsqueda sin autenticación
        const searchWithoutAuth = yield testSearchWithoutAuth();
        searchWithoutAuth ? results.passed++ : results.failed++;
        if (token) {
            // Test 5: Búsqueda con autenticación
            const searchWithAuth = yield testSearchWithAuth(token);
            searchWithAuth ? results.passed++ : results.failed++;
        }
        // Test 6: Health check
        const healthCheck = yield testHealthCheck();
