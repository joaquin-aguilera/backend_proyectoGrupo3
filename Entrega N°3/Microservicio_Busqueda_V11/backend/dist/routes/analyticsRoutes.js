 ...
 */
router.get('/top-products', rateLimit_1.rateLimit, sanitize_1.validateNumericParams, analyticsController_1.getTopProducts);
/**
 * @swagger
 * /api/analytics/stats:
 *   get:
 ...
 *         description: Error del servidor
 */
router.get('/stats', rateLimit_1.rateLimit, analyticsController_1.getSearchStats);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/top-terms', rateLimit_1.rateLimit, sanitize_1.validateNumericParams, analyticsController_1.getTopSearchTerms);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/trends', rateLimit_1.rateLimit, sanitize_1.validateNumericParams, analyticsController_1.getSearchTrends);
