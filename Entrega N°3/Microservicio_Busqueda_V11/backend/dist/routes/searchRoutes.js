...
const validateSearchParams_1 = require("../middleware/validateSearchParams");
 ...
 */
router.get('/products', rateLimit_2.searchLimiter, // Rate limit específico para búsquedas (30/min)
sanitize_1.validateSearchText, // Validar texto de búsqueda
sanitize_1.validateNumericParams, // Validar parámetros numéricos
validateSearchParams_1.validateSearchParams, // Tu validación original
 ...
 */
router.get('/products/all', rateLimit_1.rateLimit, // Rate limit básico
searchController_1.getAllProducts);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/products/random', rateLimit_1.rateLimit, sanitize_1.validateNumericParams, searchController_1.getRandomProducts);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/products/:id/detail', rateLimit_1.rateLimit, searchController_1.getProductDetail);
/**
 * @swagger
 ...
 */
router.get('/suggestions', rateLimit_2.searchLimiter, // Rate limit para sugerencias
sanitize_1.validateSearchText, // Validar texto de búsqueda
searchController_1.getSuggestions);
/**
 * @swagger
 * /api/search/history:
 *   get:
 ...
 *         description: Demasiadas solicitudes
 */
router.get('/history', rateLimit_1.rateLimit, // Rate limit básico
searchController_1.getSearchHistory);
/**
 * @swagger
 * /api/search/history:
 *   post:
 ...
 *         description: Error del servidor
 */
router.post('/history', rateLimit_2.writeLimiter, // Rate limit para escritura (20/5min)
searchController_1.saveSearchHistory);
/**
 * @swagger
 * /api/search/clicks:
 *   post:
 ...
 *         description: Error del servidor
 */
router.post('/clicks', rateLimit_2.writeLimiter, // Rate limit para escritura
searchController_1.registerProductClick);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/clicks/:productId', rateLimit_1.rateLimit, // Rate limit básico
searchController_1.getProductClicks);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/product-searches', rateLimit_1.rateLimit, // Rate limit básico
sanitize_1.validateNumericParams, // Validar parámetro 'limite'
searchController_1.getProductSearches);
