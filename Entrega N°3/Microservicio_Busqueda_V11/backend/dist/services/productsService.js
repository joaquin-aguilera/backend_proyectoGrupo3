    ...
    getProductos(filters) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const productosDB = yield Product_1.default.find({}).lean();
                if (productosDB && productosDB.length > 0) {
                    ...
                    let productos = productosDB.map((p) => {
                        ...
                        return ({
                            ...
                            marca: p.marca,
                            fecha_creacion: ((_a = p.fecha_creacion) === null || _a === void 0 ? void 0 : _a.toISOString()) || new Date().toISOString()
                        });
                    });
                    // Aplicar filtros
                    if (filters === null || filters === void 0 ? void 0 : filters.precio_min) {
                        productos = productos.filter(p => p.precio >= filters.precio_min);
                    }
                    if (filters === null || filters === void 0 ? void 0 : filters.precio_max) {
